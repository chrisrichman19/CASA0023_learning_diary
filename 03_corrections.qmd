...
For exampe, in urban areas, where spectral variability is already high, these simplifications might not be suitable for detailed analysis
...
Using LiDAR, 3D city models, and combining images from different times – as we talked about in the Applications section – shows that for cities, you often need more accuracy and context then out-of-the-box corrections.
